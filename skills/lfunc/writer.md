...
Adapted from `sources/grilling.md` (Matt Pocock, mattpocock/skills, MIT) and `sources/karpathy-guidelines.md` (Jiayuan Zhang, andrej-karpathy-skills, MIT). Their license notices are in `THIRD_PARTY_NOTICES.md` in this folder.
